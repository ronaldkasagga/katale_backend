...
/**
 * This is the model class for table "katale.market".
 *
 * The followings are the available columns in table 'katale.market':
 * @property integer $id
...
class Market extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'vendors' => array(self::HAS_MANY, 'Vendor', 'market_id'),
		);
	}
